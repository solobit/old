var afbeelding, fs, log, path, samenvoegen, siteInstellingen;
...
siteInstellingen = {
  events: {
    ...
    writeAfter: function() {},
    serverBefore: function() {},
    serverExtend: function() {},
    serverAfter: function() {},
    renderAfter: function() {
      /*
      docpad = @docpad
  ...
  templateData: {
    org: {
      ...
      vestigingen: {
        purmerend: {
          bezoekadres: samenvoegen("Wielingenstraat 119\n1441 ZN\nPurmerend\nNoord-Holland\nNederland"),
          postadres: samenvoegen("Postbus 258\n1440 AG\nPurmerend"),
          telefoon: "0299 411 345",
          fax: "0299 411 348",
          email: "info@tredius.nl",
        ...
        monnickendam: {
          bezoekadres: samenvoegen("Haringburgwal 17\n1141 AT\nMonnickendam\nNoord-Holland\nNederland"),
          postadres: samenvoegen("Postbus 48\n1140 AA\nMonnickendam"),
          telefoon: '0299 651 987',
          fax: '0299 653 004',
          email: 'info@tredius.nl',
        ...
        alkmaar: {
          bezoekadres: samenvoegen("Professor van der Waalsstraat 3K\n1821 BT\nAlkmaar\nNoord-Holland\nNederland"),
          postadres: samenvoegen("Professor van der Waalsstraat 3K\n1821 BT\nAlkmaar"),
        ...
        haarlem: {
          bezoekadres: samenvoegen("Zijlweg 146\n2015 BH\nHaarlem\nNoord-Holland\nNederland"),
